...
const AboutUs = () => {
  ...
  return (
    <div className="px-4 lg:px-[10%] py-10  overflow-hidden grid md:grid-cols-2 grid-cols-1 items-center bg-gray-950">
      ...
      >
        <h1
          className={`${integralCf.className} tracking-wider text-2xl lg:text-5xl`}
        >
          Where Vision Meets Innovation
        </h1>
        <p className="mt-10 text-sm lg:text-xl leading-loose">
